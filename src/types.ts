...
export type VoiceDraft={kind:EntryKind|null;title:string;description?:string;dueDate?:string;dueTime?:string;assigneeName?:string;needsDestinationChoice:boolean};
